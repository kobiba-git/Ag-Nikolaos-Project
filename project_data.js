...
const PROJECT_DATA = {
  ...
  weekTasks: [
    ...
    { icon: "💰", label: "New Kairis Balance — €3,520 Outstanding",
      sub: "Covers first 100 bags of grout received + first reinforcing steel + resins. €1,700 paid toward it Jul 10. Still unconfirmed whether that payment already applies against this balance — Yael re-asked Jul 11.",
      urgent: true },
    { icon: "✅", label: "Next Grout Order Approved — €7,740",
      sub: "Yael greenlit Jul 11: 200 more SikaGrout bags (€7,040) + 20 steel bars (€700). Logged as Committed. Vicky still needs to place the order.",
      urgent: false },
