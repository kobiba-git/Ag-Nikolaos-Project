...
const PROJECT_DATA = {
  ...
  weekTasks: [
    { icon: "🏗️", label: "Structural Reinforcement STARTED ✅ — RC jackets on columns",  sub: "3 Athens workers on site Mon–Fri. Process: shore → excavate column to footing → install rebar+stirrups → pour special grout cement → repeat all columns+beams. Materials: Vicky ordering bulk from factory (in bags). Cost: ALL deducted from Antonis contract price. Slab cut DEFERRED — wait until main column exposed before deciding.", urgent: true  },
  ...
  actionItems: [
    ...
    { priority: "high",     label: "🟠 High Priority",              title: "Kairis Balance ~€400 — Vicky to settle in person",
      desc: "Running balance history: Jun 13 total was ~€2,400 (€2,045 prior + €355 deferred). Jun 15: Yael approved €2,000 payment → balance now ~€400. Vicky to visit Kairis in person to settle the remaining ~€400." },
