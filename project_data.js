...
const PROJECT_DATA = {
  ...
  weekTasks: [
    ...
    { icon: "💰", label: "Kairis Balance Updated — €5,240 Debt (was €3,520)",
      ...
      urgent: false },
    { icon: "⚠️", label: "Kairis Total — €12,980 or €13,730? Discrepancy",
      sub: "Vicky's math: €5,240 debt + €7,740 next order = €12,980. She then separately said \"13,730\" with no explanation — €750 off. Ask her to confirm before treating either as final.",
      urgent: true },
  ...
  actionItems: [
    ...
    { item: "Kairis running total discrepancy: Vicky's math gives €12,980 (€5,240 + €7,740) but she separately said €13,730 — clarify which is correct", owner: "Vicky → Kobi", status: "open", date: "2026-07-11" },
  ...
  vickyComms: {
    ...
    vickyMustAction: [
      ...
      "🟡 Clarify Kairis total — €12,980 or €13,730? (Jul 11 discrepancy in her own numbers)",
