...
const PROJECT_DATA = {
  ...
  phases: [
    ...
    { icon: "🔨", status: "ongoing",  name: "Phase 2 — Storage Buildings",
      detail: "Large storage = Yael's unit. WATER ✅ + ELECTRICITY ✅ — fully operational as of June 1! Iron door ✅, aluminum door ✅ (with screen). 3-component epoxy coating on floor ✅ (permanent moisture barrier). Septic tank under construction — completion scheduled this week. Small storage under construction — door/window installation by metalworker (€550) approved." },
  ...
  actionItems: [
    ...
    { priority: "info",     label: "🔵 Info / Ongoing",             title: "Aluminum Windows & Doors",
      desc: "Large storage: aluminum door ✅ arrived with screen. Window ~1 week delay. Paid €1,150 (card). White aluminum under iron door/window. Remaining openings (~25) still TBD — color/quote decision pending." },
